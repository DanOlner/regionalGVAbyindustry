...
The next function adds in some ordinary least squares slopes for LQ change over time, to get a numerical sense of the growth trends in LQ for each region's SIC sectors. LQ_log is used so that slope scale is the same for different size sectors, so their trends are comparable.
